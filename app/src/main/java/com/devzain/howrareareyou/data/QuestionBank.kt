...
object QuestionBank {
    ...
    private val questions = listOf(
        ...
        QuizQuestion(
            ...
            options = listOf(
                AnswerOption("Yes, I've been tested and confirmed", 0.0001, "Astronomically rare",
                    traitLabel = "Confirmed perfect pitch",
                    resultNote = "Confirmed perfect pitch is astronomically rare \u2014 roughly 1 in 10,000 people, like Mozart"),
                AnswerOption("I think so but never formally tested", 0.01, "Rare",
                    traitLabel = "Possible perfect pitch",
                    resultNote = "If confirmed, you'd be 1 in 10,000 \u2014 that's an extraordinary potential musical gift"),
                AnswerOption("No, I need a reference note first", 0.9899, "Common",
                    traitLabel = "No perfect pitch",
                    resultNote = "Over 98% of people need a reference note to identify pitches \u2014 completely normal"),
            ),
        ...
        QuizQuestion(
            ...
            options = listOf(
                AnswerOption("Just my home country", 0.35, "Very common",
                    traitLabel = "Visited 1 country",
                    resultNote = "About 35% of people have never traveled outside their home country"),
                AnswerOption("2-5 countries", 0.30, "Common",
                    traitLabel = "Visited 2-5 countries",
                    resultNote = "Visiting a handful of countries is a fairly common travel experience worldwide"),
                AnswerOption("6-15 countries", 0.20, "Above average",
                    traitLabel = "Visited 6-15 countries",
                    resultNote = "You've explored more of the world than about 80% of people \u2014 nicely done!"),
                AnswerOption("16-30 countries", 0.09, "Uncommon",
                    traitLabel = "Visited 16-30 countries",
                    resultNote = "You're a well-traveled person \u2014 only about 1 in 11 people have visited this many countries"),
                AnswerOption("31-50 countries", 0.04, "Rare",
                    traitLabel = "World traveler (31-50)",
                    resultNote = "Serious globetrotter status \u2014 just 4% of people have been to this many countries"),
                AnswerOption("More than 50 countries", 0.02, "Very rare",
